        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                  <!-- Validation Errors -->
                  <form method="POST" action="{{ route('clients.store') }}" class="custom-form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                      ...
                      <input name="firstname" type="text" class="@error('firstname') is-invalid @enderror" value="{{ old('firstname') }}" />
                    </div>
                    <div>
                      <label>{{ __('Last Name') }}</label>
                      <input name="lastname" type="text" class="@error('lastname') is-invalid @enderror" value="{{ old('lastname') }}" />
                    </div>
                    <div>
